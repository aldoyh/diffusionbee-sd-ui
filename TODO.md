...
## Towards a Seamless Installation 'N' Usage

- [ ] **Installation**: Create a user-friendly installation process, possibly with a one-click installer or detailed guides for various platforms.

- [x] Revise and check then inmprove the newly added welcome page replacement then improve it dramatically.
